...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ApexDataCollection"
  spec.version      = "0.0.1"
  spec.summary      = "ApexDataCollection"
  ...
  spec.author             = { "lc1" => "827661334@qq.com" }
  # Or just: spec.author    = "lc1"
  # spec.authors            = { "lc1" => "827661334@qq.com" }
  # spec.social_media_url   = "https://twitter.com/lc1"
  ...
  spec.resource_bundles = {'resourceBundle'=> ['Resources/resource.bundle'],}
